...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Tire Storage',  path: '/tire-storage',    icon: '\u2302', need: ['INVENTORY_ADD', 'INVENTORY_EDIT'] },
    ],
  },
  {
    label: 'Admin',
    items: [
      ...
      { label: 'Discounts',  path: '/discounts',        icon: '\u2702', need: 'USER_MANAGE' },
      { label: 'Statements', path: '/statements',       icon: '\u2637', need: 'REPORT_VIEW' },
      { label: 'Pricing',      path: '/pricing-advisor',  icon: '\u2295', need: 'INVENTORY_EDIT' },
      { label: 'Marketplace',  path: '/marketplace',      icon: '\u2637', need: 'USER_MANAGE' },
